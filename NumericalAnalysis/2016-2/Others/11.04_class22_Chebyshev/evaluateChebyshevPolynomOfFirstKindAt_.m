...
function polynom = evaluateChebyshevPolynomOfFirstKindAt_( k )
    ...
    switch( k )
        ...
        case 9
         ...
         otherwise
            polynom = getnthChebyshevPolynomOfFirstKind_( k );
    ...
    if k + 1 > computed
        ...
        for i = computed : k
            ...
            elseif mod( i, 2 ) == 0
                ...
                # 2*getnthChebyshevPolynomOfFirstKind_( n/2 )^2 - 1
                polynom        = getnthChebyshevPolynomOfFirstKind_( i/2 );
                ...
                # 2*getnthChebyshevPolynomOfFirstKind_( (n-1)/2 )*getnthChebyshevPolynomOfFirstKind_( (n+1)/2 ) - x
                polynom = 2.*conv( getnthChebyshevPolynomOfFirstKind_( (i-1) / 2 ), ...
                                   getnthChebyshevPolynomOfFirstKind_( (i+1) / 2 ) );
...
polynom    = getnthChebyshevPolynomOfFirstKind_( 0 );
n          = numel( polynom ) - 1;
T0_calcula = polyout( polynom, "x" )
correct_va = T0_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 0 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T1_correct = polyout( T1(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 1 );
n          = numel( polynom ) - 1;
T1_calcula = polyout( polynom, "x" )
correct_va = T1_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 1 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T2_correct = polyout( T2(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 2 );
n          = numel( polynom ) - 1;
T2_calcula = polyout( polynom, "x" )
correct_va = T2_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 2 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T3_correct = polyout( T3(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 3 );
n          = numel( polynom ) - 1;
T3_calcula = polyout( polynom, "x" )
correct_va = T3_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 3 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T4_correct = polyout( T4(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 4 );
n          = numel( polynom ) - 1;
T4_calcula = polyout( polynom, "x" )
correct_va = T4_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 4 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T5_correct = polyout( T5(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 5 );
n          = numel( polynom ) - 1;
T5_calcula = polyout( polynom, "x" )
correct_va = T5_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 5 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T6_correct = polyout( T6(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 6 );
n          = numel( polynom ) - 1;
T6_calcula = polyout( polynom, "x" )
correct_va = T6_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 6 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T7_correct = polyout( T7(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 7 );
n          = numel( polynom ) - 1;
T7_calcula = polyout( polynom, "x" )
correct_va = T7_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 7 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )

T8_correct = polyout( T8(), "x" )
polynom    = getnthChebyshevPolynomOfFirstKind_( 8 );
n          = numel( polynom ) - 1;
T8_calcula = polyout( polynom, "x" )
correct_va = T8_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 8 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )
...
polynom    = getnthChebyshevPolynomOfFirstKind_( 9 );
n          = numel( polynom ) - 1;
T9_calcula = polyout( polynom, "x" )
correct_va = T9_( value )
calcula_va = polyval( getnthChebyshevPolynomOfFirstKind_( 9 ), value )
briotRunif = fPnPorBriotRunifi( n, fliplr( polynom ), value )
printf( '\n' )
