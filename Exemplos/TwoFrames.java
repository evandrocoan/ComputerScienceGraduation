...
public class TwoFrames
{
   ...
   {
      /* Here we are Secheduling a JOB for Event Dispatcher Thread, since Swing is not Thread Safe.
       * This is used to place the code which is responsible for creating and diaplaying your GUI. */
