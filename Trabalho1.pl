...
formacaoNoCursoDe( ['Pessoa1 da Silva1', 'Ciencias da Computacao', 'UFSC', 
'Silva9 da Pessoa1', 2007, 2012, 'Bruno Mars', 'Rock Star' ] ).
formacaoNoCursoDe( ['Pessoa2 da Silva9', 'Ciencias da Automacao', 'UFMG', 
'Silva8 da Pessoa2', 2005, 2010 ] ).
formacaoNoCursoDe( ['Pessoa3 da Silva7', 'Engenharia da Computacao', 'USP', 
'Silva7 da Pessoa3', 2009, 2015, 'Silvio Santos' ] ).
formacaoNoCursoDe( ['Pessoa4 da Silva7', 'Ciencias Biologicas', 'UNICAMP', 
'Silva6 da Pessoa4', 2002, 2012, 'Silvio Santos', 'Bruno Mars' ] ).
formacaoNoCursoDe( ['Pessoa5 da Silva7', 'Engenharia da Computacao', 'UFSC', 
'Silva5 da Pessoa5', 2000, 2005, 'Roberto Carlos' ] ).
formacaoNoCursoDe( ['Pessoa6 da Silva5', 'Ciencias Juridicas', 'UFSC', 
'Silva4 da Pessoa5', 2002, 2012 ] ).
formacaoNoCursoDe( ['Pessoa6 da Silva4', 'Ciencias Sociais', 'ITA', 
'Silva4 da Pessoa6', 2007, 2013 ], 'Demi Lovato' ).
formacaoNoCursoDe( ['Pessoa8 da Silva2', 'Engenharia Mecânica', 'UFSC', 
'Silva3 da Pessoa7', 2008, 2011, 'Marshall Mathers III' ] ).
formacaoNoCursoDe( ['Pessoa9 da Silva2', 'Ciencias da Computacao', 'ITA', 
'Silva2 da Pessoa8', 2003, 2007, 'Avril Lavigne', 'Demi Lovato' ] ).
