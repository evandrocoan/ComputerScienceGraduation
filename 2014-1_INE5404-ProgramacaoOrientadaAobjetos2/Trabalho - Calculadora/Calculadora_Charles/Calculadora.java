...
public class Calculadora {
	...
	private void initialize() {
		...
		btn7.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn8.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn9.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn4.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn5.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn6.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn2.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn3.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btn0.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btnDot.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btnExp.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		...
		btnDivisao.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btnMultiplicacao.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btnSubtracao.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btnSoma.setFont(new Font("Lucida Grande", Font.PLAIN, 14));
		...
		btnMaisMenos.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		
		//--------------------------------------------------------------------
		//UP - rolagem da pilha, somente da pilha entrada
		//--------------------------------------------------------------------
		...
		btnUp.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		...
		btnSwap.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		...
		btnInversao.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		...
		btnSqrt.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		
		//------------------------------------------------------------------------------
		//ENTER - s— para nœmeros na base decimal
		//------------------------------------------------------------------------------
			...
			{	
				...
				if(!erro)
				{
					...
					try
					{
						...
						{
							if(tipoBase==0)//s— armazena nœmeros na base decimal
							{
								if(!valor.stringVazia(valor.retornaStringDigitada()))
								{
		...
		btnEnter.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		//------------------------------------------------------------------------------
		...
		btnX2.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		//------------------------------------------------------------------------------
		...
		btnUndo.setFont(new Font("Lucida Grande", Font.PLAIN, 11));
		//-------------------------------------------------------------
		...
		btnDel.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		panelTecladoSecundario.setBounds(14, 201, 259, 82);
		...
		{	
			public void actionPerformed(ActionEvent e)
			{
				...
				{	
					...
					btnAb.setToolTipText("M‡ximo Divisor Comum entre dois nœmeros.");
		...
		btn2nd.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		...
		btnPol.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		...
		btnRet.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		...
		btnHyp.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		panelTecladoSecundario.add(btnHyp);
		
		btnSto.setToolTipText("Armazena nr [<nr> <ENT><A><STO>], apaga nr [<A><\u00B1><STO>]");
		//---------------------------------------------------------
		
		//ARMAZENA DADO NA MEMîRIA - A B C D E F 
		//---------------------------------------------------------
		...
		btnSto.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnPi.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		...
		btnHms.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnSin.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnCos.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnTan.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnRand.setFont(new Font("Lucida Grande", Font.PLAIN, 12));
		...
		btnAb.setFont(new Font("Lucida Grande", Font.PLAIN, 10));
		...
		btnYx.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnLog.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		...
		btnLn.setFont(new Font("Lucida Grande", Font.PLAIN, 13));
		panelTecladoSecundario.add(btnLn);
		//---------------------------------------------------------------------
		
		JPanel panelTecladoHexa = new JPanel();
		panelTecladoHexa.setBounds(18, 172, 246, 18);
		...
		textFieldLinha1.setBounds(14, 138, 253, 32);
		...
		textFieldLinha2.setBounds(14, 111, 253, 32);
		...
		textFieldLinha3.setBounds(14, 84, 253, 32);
		...
		textFieldLinha4.setBounds(14, 57, 253, 32);
		...
		textFieldAuxiliar.setBounds(14, 39, 253, 16);
